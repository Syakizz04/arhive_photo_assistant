...
def run_full_pipeline(
    ...
    print("\n[1/3] Running Module 1: Image Preprocessing...")
    ...
    print("\n[2/3] Running Module 2: Quality Assessment...")
    ...
    print("\n[3/3] Running Module 3: Fading Analysis...")
    final_metadata = analyze_fading_folder(
        metadata_dir=meta_dir,
        write_back=True,
    )
...
def run_existing_metadata(
    ...
    """
    Run only the analysis modules (2-3) on existing metadata JSON files.
    ...
    # Module 2: Quality Assessment
    print("\n[1/2] Running Module 2: Quality Assessment...")
    quality_metadata = assess_quality_folder(
        metadata_dir=meta_dir,
        write_back=True,
    )
    ...
    # Module 3: Fading Analysis
    print("\n[2/2] Running Module 3: Fading Analysis...")
    final_metadata = analyze_fading_folder(
        metadata_dir=meta_dir,
        write_back=True,
    )
